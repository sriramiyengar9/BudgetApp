...
var budgetController = (function () {
    ...
    return {
        addItem: function (type, des, val) {
            ...
            //push new item to data stucture
        ...
        calculateBudget: function () {
            ...
            // calculcate budget = income - expense
...
var UIController = (function () {
    ...
    var formatNumber = function (num, type) {
        ...
        //todo + or - before the numbers
        //todo exactly 2 decimals
        //todo commas 
    ...
    var getCurrentMonthName = function (monthNumber) {
        var months = ['January',
            'February',
            'March',
            'April',
    ...
    return {
        ...
        addListItem: function (obj, type) {
            ...
            // replace placeholder text with data received
        ...
        clearFields: function () {
            ...
            fieldsArray[0].focus(); // returning focus back to the description
        },
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var updatePercentage = function () {
        ...
        // read the percentage from Budget Ctrl
